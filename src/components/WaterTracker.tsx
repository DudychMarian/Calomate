...
type WaterTrackerProps = { showTitle: boolean, showProgress: boolean, showGlassCount: boolean }

export default function WaterTracker({ showTitle, showProgress, showGlassCount }: WaterTrackerProps) {
